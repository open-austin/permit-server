module.exports = {
    ...
    '4': {
        text: "Will this project involve any structural members <span class='tooltip'><sup>[?]</sup></span> or increase square footage of structure?",
        tooltip: '<div style="float: left; position: relative; left: 50%;"><div style="float: left; margin: 0 0 0 0.5em; padding: 0.25em; position: relative; left: -50%; text-align: justify; width: 90%;" class="tip-content">Support that is a consitiuent part of any structure or building, for example:<br><br>\n\n\Beam - long thick piece of wood or metal or concrete, etc., used in construction<br>\nBracing, brace - a structural member used to stiffen a framework<br>\nPlate - structural member consisting of a horizontal beam that provides bearing and anchorage<br>\nRiser - structural member consisting of the vertical part of a stair or step<br>\nSill - structural member consisting of a continuous horizontal timber forming the lowest member of a framework or supporting structure<br>\nStructure, construction - a thing constructed; a complex entity constructed of many parts; <br>\nSupport - any device that bears the weight of another thing; <br>\nTread - structural member consisting of the horizontal part of a stair or step<br>\nUpright, vertical - a vertical structural member as a post or stake.</div></div>',
        answers: {
            'Yes': { next: 2 },
            'No': { next: 5 }
        },
