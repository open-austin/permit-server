module.exports = {
  ...
  '6': {
    text: 'You have qualified for an express permit',
    caption: '<div class="inner-container"><h5>Check your property for Airport Overlay Zoning</h5> Click the link below. Then enter your address into the search bar. Change “Map Themes” to zoning map, and in “Layers” under “Zoning and Zoning Overlays” check the box for Airport Overlay and National Register of Historic Districts <a class="wizard-links" href="http://www.austintexas.gov/GIS/DevelopmentWebMap/Viewer.aspx">http://www.austintexas.gov/GIS/DevelopmentWebMap/Viewer.aspx</a></p><h5>Is your property in a Airport Overlay Zone?</h5></div>',
    answers: {
    ...
    '7': {
		...
		caption: '<div class="inner-container"><h5>Check your proximity to a flood plain.</h5> Visit either of the links below.<p><a class="wizard-links" href ="www.ATXFloodPro.com">www.ATXFloodPro.com</a> or the City’s Floodplain Development Information website <a class="wizard-links" href ="http://austintexas.gov/page/floodplain-development-information">http://austintexas.gov/page/floodplain-development-information</a></p><h5>Is your property within 150 feet of a floodplain?</h5></div>',
        answers: {
    ...
    '8': {
		...
		caption: '<div class="inner-container"><h5>Check at this link:</h5><p><a class="wizard-links" href="https://www.austintexas.gov/devreview/a_queryfolder_permits.jsp">https://www.austintexas.gov/devreview/a_queryfolder_permits.jsp</a></p><h5>Do you have expired permits?</h5></div>',
        answers: {
            'Yes': { next: 9 },
            'No': { next: 12 }
        }
